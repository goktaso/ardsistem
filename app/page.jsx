  ...
  return (
    <div className={`fixed bottom-8 right-8 z-[999] flex flex-col items-end gap-3 transition-all duration-700 ${visible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
      ...
      <button
        ...
        className={`flex items-center gap-3 rounded-full font-black text-white text-sm shadow-2xl transition-all duration-300 ${open ? 'p-4' : 'p-4 sm:py-4 sm:px-6'}`}
        style={{
      ...
      >
        ...
        {!open && <span className="hidden sm:inline">WhatsApp ile Yaz</span>}
      </button>
    </div>
  )
}
...
export default function App() {
  ...
  return (
    <main className="min-h-screen text-slate-100 font-sans overflow-x-hidden" style={{ backgroundColor: '#05080f', color: '#f1f5f9' }}>
      ...
      {/* ── VAKA KARTLARI ── NOT: DATA içeriği kurgusal/placeholder, production'a almadan önce gerçek verilerle değiştirilmeli */}
      <CaseStudyCards />
      ...
      <section id="iletisim" className="py-32 relative overflow-hidden" style={{ backgroundColor: '#ea580c' }}>
        ...
        <div className="container mx-auto px-6 relative z-10">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-6 mb-10 p-6 rounded-2xl" style={{ backgroundColor: 'rgba(0,0,0,0.2)', border: '1px solid rgba(255,255,255,0.1)' }}>
            ...
            <div className="flex flex-col sm:flex-row flex-wrap items-stretch sm:items-center justify-center gap-3 sm:ml-auto">
              <a href={`tel:${BRAND.phone}`} className="inline-flex items-center justify-center gap-2 whitespace-nowrap text-xs font-black px-4 py-2.5 rounded-xl transition-all hover:bg-white/15" style={{ backgroundColor: 'rgba(255,255,255,0.1)', color: '#fff', border: '1px solid rgba(255,255,255,0.15)' }}>
              ...
              <a href={`mailto:${BRAND.email}`} className="inline-flex items-center justify-center gap-2 whitespace-nowrap text-xs font-black px-4 py-2.5 rounded-xl transition-all hover:bg-white/15" style={{ backgroundColor: 'rgba(255,255,255,0.1)', color: '#fff', border: '1px solid rgba(255,255,255,0.15)' }}>
                <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="shrink-0"><rect x="2" y="4" width="20" height="16" rx="2"/><path d="m22 7-8.97 5.7a1.94 1.94 0 0 1-2.06 0L2 7"/></svg>
                {BRAND.email}
              </a>
            </div>
          </div>
